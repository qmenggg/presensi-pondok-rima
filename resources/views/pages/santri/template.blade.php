...
@section('content')
    <div class="space-y-6">
            ...
            <div>
                <nav class="flex mb-2" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <li class="font-medium text-gray-900 dark:text-white">Download Template</li>
                    </ol>
                </nav>
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Download Template</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Download template Excel untuk import data santri</p>
            </div>
        ...
        <!-- Livewire Template Component -->
        @livewire('santri-template')
    </div>
@endsection
